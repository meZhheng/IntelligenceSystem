    ...
    <div class="item">
                ...
                <div class="item_header_title">
                    ...
                    >   
                        <el-option 
                            ...
                            :key="item.value"
                            :label="getModelLabel(item.label)"
                            :value="item.value"
            ...
            <div class="item_header_right">
                <div class="right_item">
                    <el-progress type="circle" 
                        ...
                        ? parseFloat((analysisStats.normal * 100 / analysisStats.total).toFixed(1)) : 0" 
                    ...
                    <div class="circle_description">
                        <span>正常内容</span>
                        <span class="main_items">{{ analysisStats.normal }}</span>
                        <el-progress 
                            :stroke-width="5" 
                            :percentage="analysisStats.total > 0 
                            ? parseFloat((analysisStats.normal * 100 / analysisStats.total).toFixed(1)) : 0" 
                ...
                <div class="right_item">
                    <el-progress type="circle"                             
                        :percentage="analysisStats.total > 0 
                        ? parseFloat((analysisStats.illegal * 100 / analysisStats.total).toFixed(1)) : 0"  
                    ...
                    <div class="circle_description">
                        <span>风险信息</span>
                        <span class="main_items">{{ analysisStats.illegal }}</span>
                        <el-progress 
                            :stroke-width="5" 
                            :percentage="analysisStats.total > 0 
                            ? parseFloat((analysisStats.illegal * 100 / analysisStats.total).toFixed(1)) : 0"  
        ...
        <div class="chart_list">
            ...
            <div class="chart_list_row">
                <AutoScrollWindow :items="passRollingTextPos" title="正常内容" />
                <AutoScrollWindow :items="passRollingTextNeg" title="风险信息" />
            </div>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            // 导入数据集相关变量
            datasetExcept: [] as Array<string | number>,
            datasetSelectable: [] as Array<{ value: string | number; label: string }>,
            datasetToImport: [] as Array<string | number>,

            model_selected: [] as string[],
            model_selected_tmp: null as string | null,
            analysisStats: {
                total: 0,
                normal: 0,
                illegal: 0,
                ...
                normal: number;
                illegal: number;
                normal_data: Array<Record<string, any>>;
                illegal_data: Array<Record<string, any>>;
            },
            dataset_selected: [] as Array<string | number>,
            analysisProgress: 0 as number,


            LineChartData: null,
            modelOptions: [] as Array<{ value: string; label: string; status: number }>,
            datasetOptions: [] as Array<{ value: string; label: string; type_name?: string }>,
            ...
            rows_pos : [] as Array<Record<string, any>>,
            rows_neg : [] as Array<Record<string, any>>,
            ...
            group: null as null | { id: number; default?: boolean },
        }
    },
    ...
    methods: {
        ...
        // 有问题无法执行
        async setGroupStatus(groupVal?: number) {
