...
export default (await import('vue')).defineComponent({
    ...
    computed: {
        filteredTargets() {
            ...
            return this.availableTargets.filter((t) => t.includes(this.filterQuery));
        }
    },
    methods: {
        // 初始化图表
...
const __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40({
    ...
    filterable: (true),
    placeholder: ("选择分析目标"),
    filterMethod: ((__VLS_ctx.filterTargets)),
}));
...
let __VLS_44;
{
    ...
    const __VLS_49 = __VLS_asFunctionalComponent(__VLS_48, new __VLS_48({
        ...{ 'onChange': {} },
        modelValue: ((__VLS_ctx.checkAll_words)),
        indeterminate: ((__VLS_ctx.indeterminate_words)),
    }));
    ...
    let __VLS_54;
    const __VLS_55 = {
        onChange: (__VLS_ctx.handleCheckAll_words)
    };
    let __VLS_51;
    let __VLS_52;
    (__VLS_ctx.filteredTargets.length);
    __VLS_53.slots.default;
    var __VLS_53;
}
for (const [target] of __VLS_getVForSourceType((__VLS_ctx.filteredTargets))) {
...
['disable-select', 'chart-title', 'title-text', 'time_selector', 'date-box', 'date-input',];
var __VLS_special;
let __VLS_self;
