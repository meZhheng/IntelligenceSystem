...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # .../VAD/utils
lex_path = os.path.join(BASE_DIR, "NRC-VAD-Lexicon.txt")
...
class ErcTextDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, DATASET='MELD', SPLIT='train', speaker_mode='upper',
        ...
        if "adapter" in model_checkpoint:
            ...
            self.model_checkpoint = "/webfile/checkpoints/roberta-base"
